...
package com.zjm.springbootfast.common.config;
...
import com.zjm.springbootfast.common.exception.SpringBootFastConfigException;
import com.zjm.springbootfast.common.properties.SwaggerProperties;
...
public class Swagger2Config {
    ...
    public String[] getBasePackages() {
        ...
        if (StringUtils.isBlank(basePackage)) {
            throw new SpringBootFastConfigException("Swagger basePackage不能为空");
        }
